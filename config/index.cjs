  ...
  USERS: [
    {
      ...
      useTemplateId: 'mFzef1OAVVrsvM6IGH7WAqVKjshu9JigU7yno6fnv0s',
...
//         {
//           type: '节日', name: '在一起', year: '2019', date: '08-09',
//         },
      ],
      // 我们在一起已经有xxxx天了的配置
      customizedDateList: [
  ...
  CALLBACK_TEMPLATE_ID: '2eX5gAW2kKPgX18ENTF3JuiZLv_FciczEczd8DB5rRA',
